...
public class ResourcesNotFoundException extends RuntimeException { //A minha excessao customizada para que ela seja uma excessao do java e que responda o try cath eu tenho que extender ela da excessao do java, no caso eu coloquei a RunTime pq ela nao exige que vc coloque um try catch
